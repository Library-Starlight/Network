...
namespace Jhpj.Crypto
{
    ...
    public class RsaProvider
    {
        ...
        public RsaProvider(RsaType rsaType)
        {
        ...
        /// <returns></returns>
        public bool Verify(string data, string sign, string publicKey)
        {
            byte[] dataBytes = _encoding.GetBytes(data);
        ...
        /// <param name="privateKey">私钥</param>
        /// <returns></returns>
        public static string Signature(string plainText, string privateKey)
        {
            var provider = new RsaProvider(RsaType.RSA2);
            return provider.Sign(plainText, privateKey);
        }
        ...
        /// <param name="publicKey">公钥</param>
        /// <returns></returns>
        public static bool Validate(string sign, string plainText, string publicKey)
        {
            var provider = new RsaProvider(RsaType.RSA2);
            return provider.Verify(plainText, sign, publicKey);
        }
